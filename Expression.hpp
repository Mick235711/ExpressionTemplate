...
#undef DEF_BINARY_OP
    ...
    namespace statements
    {
        ...
        public:
            ...
            typedef while_type<cond_t, loop_t> class_type;
        ...
        public:
            // functions
            while_type(const cond_type& c, const loop_type& l)
                : cond(c), loop(l)
            {}
        ...
        public:
            // functions
            explicit while_t(const cond_type& c)
                : cond(c)
            {}
            ...
            {
                return while_type<cond_type, loop_t>(cond, loop);
            }
        };
